                    ...
                    i.default.playerTouch && null != a.default.Instance.targetFruit && 1 == this.touchNum && (this.touchNum = 0,
                        ...
                        this.scheduleOnce(function() {
                            i.default.GameUpdateCtrl && (0 == t.createFruitCount ? (a.default.Instance.createOneFruit(2),
                                t.createFruitCount++) : 1 == t.createFruitCount ? (a.default.Instance.createOneFruit(3),
                                t.createFruitCount++) : 2 == t.createFruitCount ? (a.default.Instance.createOneFruit(4),
                                t.createFruitCount++) : 3 == t.createFruitCount ? (a.default.Instance.createOneFruit(5),
                                t.createFruitCount++) : 4 == t.createFruitCount ? (a.default.Instance.createOneFruit(6),
                                t.createFruitCount++) : 5 == t.createFruitCount ? (a.default.Instance.createOneFruit(7),
                                t.createFruitCount++) : 6 == t.createFruitCount ? (a.default.Instance.createOneFruit(8),
                                t.createFruitCount++) : 7 == t.createFruitCount ? (a.default.Instance.createOneFruit(9),
